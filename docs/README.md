...
| 实施图谱 | 协调跨工作流状态、证据和 TypeSpec/Go/SQL 映射 | [身份平台台账](implementation/identity-platform-ledger.md)、[契约映射](implementation/identity-platform-contract-map.md)、[平台底座任务](implementation/platform-foundation-tasks.md) |
