...
export COMPOSE_PROJECT_NAME="${COMPOSE_PROJECT_NAME:-starter-check-$$}"
export POSTGRES_PORT="${POSTGRES_PORT:-55432}"
export DATABASE_URL="${DATABASE_URL:-postgres://starter:starter@127.0.0.1:${POSTGRES_PORT}/starter?sslmode=disable}"
